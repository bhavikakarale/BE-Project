	...
	return (
		<React.Fragment>
			...
			<main className="about">
				...
				<p>
					Speech2Code is an desktop application that let's you control
					your favorite IDE using just voice commands, <br />
					that means you can write programs using just your voice,
					without typing on the keyboard. It was developed <br /> as
					part of my undergraduate project in Computer Engineering.
				</p>
				<p>
					This demo website allows you test Speech2Code in the browser
					without installing it on your local machine.
					<br />
					This is possible because this entire application is
