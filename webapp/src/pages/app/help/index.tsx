		...
		<main className="help">
			<div className="wrapper">
				<div className="title">
					...
					<div className="sub">
						{i18n(lang)('Some information about Speech2Code')()}
					</div>
				</div>
				{/* <div className="body">
...
const Link = (props: { h: any; children: any }) => (
	<a
		href={
			'https://github.com/pedrooaugusto/speech-to-code/tree/main/spoken/src/modules/typescript/' +
			props.h +
			'#readme'
		}
		target="_blank"
...
const texts: Record<string, Record<string, any>> = {
	...
	'pt-BR': {
		Help: () => 'Ajuda',
		'Some information about Speech2Code': () =>
			'Informações sobre como usar esta ferramenta'
	}
}

const i18n = (lang: string) => (textId: string) =>
	texts[lang][textId] || (() => textId)
