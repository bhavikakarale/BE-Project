							...
							>
								<div className="module__title">
									...
									<i
										...
										className="fa fa-angle-down angle"
									/>
									{/* <a
                                        target="_blank"
                                        rel="noreferrer"
								...
								<div className="module__commands">
									<ul>
										{mod.grammar[context.language].map(
											(c: any) => {
												return (
													<li
														onClick={() => {
						...
						<div className="wrapper">
							<div className="main-header">
								...
								{/* <a
									target="_blank"
									rel="noreferrer"
									href={`${DOC_LINK}/${modalInfo.module.id}/${
										modalInfo.command.id
									}#${capitalize(
										modalInfo.command.langName
									)}`}
									title="More information about this command"
								>
									<i className="fa fa-info-circle info" />
