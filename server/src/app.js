...
http.listen(process.env.PORT || 3000, () => {
	...
	console.log('[server.app] (Current Work)Access the web version demo by visiting: http://localhost:3000/app/')
	console.log('[server.app] (Future Work)Access the web version demo by visiting: http://localhost:3000/webapp/')
	...
	console.log('[server.app] (Pending) Dont forget to edit /server/.env with your Azure speech-to-text API keys')
})
